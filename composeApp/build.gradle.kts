...
configurations.all {
    resolutionStrategy {
        force("org.jetbrains.kotlin:kotlin-stdlib-wasm-js:2.1.0") // or your Kotlin version
    }
}
    ...
    sourceSets {
        ...
        commonMain.dependencies {
           ...
           // implementation(libs.kotlinx.coroutines.android)
            /*implementation(libs.media.kamel.decoder.fetcher.resources.jvm)*/
            /*  implementation(libs.media.kamel.decoder.fetcher.resources.android)*/
